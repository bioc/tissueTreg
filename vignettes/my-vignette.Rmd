...
```{r loading}
BS.obj.ex.fit <- readRDS(file = "/icgc/dkfzlsdf/analysis/G200/imbusch/treg/treg_experimentHub/treg_twgbs_per_sample.rds")
```
...
```{r loading_group}
BS.obj.ex.fit.combined <- readRDS(file = "/icgc/dkfzlsdf/analysis/G200/imbusch/treg/treg_experimentHub/treg_twgbs_per_group.rds")
```
...
pData$col <- c("red", "blue", "green", "yellow", "orange")
