...
BS.obj.ex.fit2_smoothed <- BSmooth(BS.obj.ex.fit2, mc.cores=12, verbose=TRUE, parallelBy = "chr")
saveRDS(object = BS.obj.ex.fit, file = "treg_twgbs_per_sample.rds")
...
BS.obj.ex.fit.combined_smoothed <- BSmooth(BS.obj.ex.fit.combined2, mc.cores=12, verbose=TRUE, parallelBy = "chr")
saveRDS(object = BS.obj.ex.fit, file = "treg_twgbs_per_group.rds")
